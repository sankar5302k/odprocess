...
interface OdStatusCheckProps {
  onCheck: (studentId: string) => Promise<void>
}
    ...
    <div className=" mt-[90px]">
      <div className="max-w-md mx-auto ">
        <form onSubmit={handleSubmit} className="bg-gradient-to-r from-purple-500 to-purple-600 p-6 rounded-lg shadow-lg">
          ...
          <button
            type="submit"
            disabled={!studentId.trim() || loading} // Disable button if empty or loading
          ...
          >
            {loading ? "Checking..." : "Check OD Status"}
          </button>
        </form>
      </div>
    </div>
